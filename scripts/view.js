...
const printAllMovies = () => {
  ...
  movieTitles.forEach((movie) => {
    ...
    p.addEventListener('click', () => {
      let minutesMovies = hoursToMinutes(movies);
      let theMovie = minutesMovies.find((m) => m.title == movie);
      list.textContent = '';
      let div = document.createElement('div');
      ...
      year.textContent = `Year: ${theMovie.year}`;
      year.classList.add('text-xl');
      year.classList.add('font-bold');
      year.classList.add('mb-2');
      year.classList.add('block');
      year.classList.add('mx-auto');
      director.textContent = `Director: ${theMovie.director}`;
      director.classList.add('text-xl');
      director.classList.add('font-bold');
      director.classList.add('mb-2');
      director.classList.add('block');
      director.classList.add('mx-auto');
      duration.textContent = `Duration: ${theMovie.duration} '`;
      duration.classList.add('text-xl');
      duration.classList.add('font-bold');
      duration.classList.add('mb-2');
      duration.classList.add('block');
      duration.classList.add('mx-auto');
      genre.textContent = `Genre: ${theMovie.genre} `;
      genre.classList.add('text-xl');
      genre.classList.add('font-bold');
      genre.classList.add('mb-2');
      genre.classList.add('block');
      genre.classList.add('mx-auto');
      score.textContent = `⭐️ ${theMovie.score}`;
      ...
      title.textContent = theMovie.title;
